...
if plots
    ...
    figure(10), plot(Ta, alpha+settings.OMEGA*180/pi), title('Alpha vs time'), grid on;
    figure(11), plot(Ta, beta), title('Beta vs time'), grid on;
    figure(12), plot(Ta, roll), title('Roll vs time'), grid on;


    % Mach
    figure(13), plot(T, M), grid on;
